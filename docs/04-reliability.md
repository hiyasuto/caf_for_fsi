...
> FISC実務基準（実39〜実45, 実71〜実72）→ Azure Reliability（設計・アーキテクチャ）

## 概要

FISC基準におけるバックアップ設計・DRアーキテクチャ要件を、Azure WAFの**信頼性の柱**（Reliability Pillar）に基づいて実現します。本ドキュメントは「**どう設計するか**」に焦点を当てています。
