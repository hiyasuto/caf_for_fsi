...
| 03 | [セキュリティ](docs/03-security.md) | 認証・暗号化・ネットワーク・サイバー対策 | 実1〜実22, 実25〜実30 |
| 04 | [信頼性・事業継続](docs/04-reliability.md) | バックアップ・DRアーキテクチャ設計 | 実39〜実45, 実71〜実74, 実102〜実105 |
| 05 | [運用管理](docs/05-operations.md) | システム運用・監視・変更管理 | 実23〜実24, 実34〜実62 |
...
| 10 | [障害シナリオと演習](docs/10-disaster-exercise.md) | 障害シナリオ策定・机上/実機演習・カオスエンジニアリング | 統5-4, 実72 |
| 11 | [インシデント対応計画](docs/11-incident-response.md) | インシデント分類・対応プロセス・フォレンジック | 実73-1, 実59, 統5-4 |
| 12 | [コンティンジェンシープラン](docs/12-contingency-plan.md) | FISC手引書5工程・RTO/RPO設計・縮退運転・PDCA | 実73 |
...
| ディレクトリ | 概要 |
|------------|------|
| [fisc-reference/](fisc-reference/) | FISC 安対基準13版・CP手引書5版の章番号順索引（本リポジトリ内 Azure 対応分析への相互参照） |
| [fisc-reference/security-guidelines/](fisc-reference/security-guidelines/) | 安対基準13版（統制36 / 実務152 / 設備134 / 監査2）の基準番号順索引 |
| [fisc-reference/contingency-plan/](fisc-reference/contingency-plan/) | コンティンジェンシープラン手引書5版（策定編 / 災害発生時対応編 / サンプル編）の索引 |
