...
### マルチモデル対応（Azure AI Foundry Model Catalog）

Azure AI Foundry は **マルチモデルプラットフォーム** であり、ユースケースに応じて最適なモデルを選択できます。以下のモデルが Azure から直接利用可能です。
...
| マルチモデル | Azure AI Foundry Model Catalog | Grok / DeepSeek / Claude / Llama / Mistral 等（Marketplace含む） | ユースケース別の最適モデル選定 |
